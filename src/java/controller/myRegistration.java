...
public class myRegistration extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (Registration registration : listC) {
                System.out.println(registration.getRegistration_id());
            }
            ...
            Logger.getLogger(myRegistration.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
