...
public class UserAuthorizationFilter implements Filter {
    ...
    private boolean hasPermission(String role, String url) {
        ...
        else if(url.contains("slider") || url.contains("updateBlog")){
            return role.equals("Marketing");
        }
        
        else if(url.contains("myCourse") || url.contains("myRegistration")){
        ...
        else if(url.contains("manageRegistration")){
            return role.equals("Sale");
        }
        return true;
    }
