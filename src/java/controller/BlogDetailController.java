...
public class BlogDetailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Blog blog = dao.getDetailBlogs(id);
        request.setAttribute("blog", blog);
        
        int author_id = blog.getBlog_id();
        String author = dao.getAuthor(author_id);
        request.setAttribute("author", author);
        
        int category_id = blog.getCate_id();
        String category = dao.getCategoryName(category_id);
        request.setAttribute("category", category);
        
        List<BlogCategory> listCategory = new BlogDAO().getBlogCategories();
